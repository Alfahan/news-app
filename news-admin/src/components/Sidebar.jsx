...
export default function Sidebar() {
    ...
    // assigning location variabel
    const location = useLocation();

    // desctructuring pathneme from location
    ...
    return(
        <div>
            <nav id="sidebarMenu" className="sidebar d-lg-block bg-tertiary text-white collapsable" data-simplebar>
